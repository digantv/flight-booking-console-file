...
public class UserManagement {
	...
	public static void userManagement() throws IOException {
		...
		while (canIKeepRunningTheProgram == true) {
			...
			if (optionSelectedByUser == UserOptions.QUIT) {
				File file = new File(
						"C:\\Users\\yash\\eclipse-workspace\\FlightBookingSystem\\src\\user_management\\user.csv");
				FileWriter fr = new FileWriter(file, false);
				BufferedWriter br = new BufferedWriter(fr);

				for (User user : al) {
					br.write(user.userName + "," + user.loginName + "," + user.password + "," + user.userRole);
				}
				br.close();
				fr.close();
				file = null;
	...
	public static void loadDataFromFileToArrayList() throws IOException {
		...
		File file = new File("C:\\Users\\yash\\eclipse-workspace\\FlightBookingSystem\\src\\user_management\\user.csv");
